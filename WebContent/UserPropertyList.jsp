	...
	<section class="content">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="userPropertyList?userId=<%=sessionBean.getUser_id()%>" class="small-box-footer">All info <i class="fa fa-arrow-circle-down"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                ...
                <a href="http://localhost:6018/Designing/userBookingList?userId=<%=sessionBean.getUser_id() %>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
